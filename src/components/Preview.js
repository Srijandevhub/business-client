...
const Preview = ({ profilePicture, themeName, fname, lname, company, designation, socialLinks, showWhatsapp, whatsappNumber, whatsappMessage, phoneCode, phoneNumber, email, country }) => {

    const handleSendWhatsapp = () => {
        var api = `https://wa.me/${whatsappNumber}?text=${whatsappMessage}`;
        window.open(api);
    }

    return (
        <div className={`preview ${themeName}`}>
            <div className="basic-box">
                <i className="profile-image"><img src={profilePicture} alt="profile"/></i>
                <div>
                    <h1 className="name">{fname} {lname}</h1>
                    <p className="company-desination">{company} - {designation}</p>
                </div>
                {
                ...
                <ul className="contact-box">
                    <li>
                        ...
                        <Link className="contact-link" to={`tel:${phoneNumber}`}>+{phoneCode} {phoneNumber}</Link>
                    </li>
                    <li>
                        <i>
                            <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        ...
                        <Link className="contact-link" to={`mailto:${email}`}>{email}</Link>
                    </li>
                    <li>
                        <i>
                            <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        ...
                        <span className="contact-link">{country}</span>
                    </li>
                </ul>
            </div>
            {
