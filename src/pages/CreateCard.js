...
const CreateCard = () => {
    ...
    const handleSave = async () => {
        ...
        if (valid) {
            ...
            const res = await axios.post(`${backendUrl}/card/savecard`, formData, {
    ...
    if (localStorage.getItem("modules")) {
        if (!JSON.parse(localStorage.getItem("modules")).cardmanagementaccess.create) {
                                                        ...
                                                        <div className="col-6" key={el.id}>
                                                            <div className="signup-form-phone-wrapper mb-20px">
                                                                <div className="phonecode-select social-select">
                                                                    <select onChange={(e) => handleSocialType(el.id, e.target.value)}>
                                                                ...
                                                                <input type="text" className="signup-input social-link-input" onChange={(e) => handelSocialLinks(el.id, e.target.value)}/>    
